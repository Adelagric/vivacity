...
Vérifié après la 0.15.0 (comme après la 0.14.0 et la 0.13.0) : binaire GitHub (checksum, `--version`, aucune
PCRE2 dynamique, symboles `vivacity_pcre2_*`), `cargo install vivacity
--version 0.15.0` depuis crates.io, install réel avec ce binaire (Laravel, 109
