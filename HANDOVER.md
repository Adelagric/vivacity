...
harness/merge-plugin.sh [variante...]    # wikimedia/composer-merge-plugin : 5 variantes × install, dump -o, dump -a, --no-dev (référence = plugin pré-amorcé, lock inchangé vérifié) + exigence absente (vendor chaud : code 4 identique ; vierge : repli avec la raison) + `update` refusé
...
## Publication sur crates.io (dernière : 0.14.0 le 2026-09-18)
