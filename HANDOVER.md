...
Vérifié après la 0.16.0 (comme après chaque version depuis la 0.13.0) : binaire GitHub (checksum, `--version`, aucune
PCRE2 dynamique, symboles `vivacity_pcre2_*`), `cargo install vivacity
--version 0.16.0` depuis crates.io, install réel avec ce binaire (Laravel, 109
