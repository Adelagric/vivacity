...
harness/flex-update.sh                   # `update` AVEC install sur un projet Flex (tranche B) : natif quand rien de neuf n'est posé et qu'aucune recette ne s'applique, repli (rien d'écrit) pour une recette de l'index, une classe de bundle, ou un paquet à poser
