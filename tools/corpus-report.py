...
PLUGIN_EVENTS = {
    ...
    "phpstan/extension-installer": "post-autoload-dump; writes src/GeneratedConfig.php",
    "rector/extension-installer": "post-autoload-dump; writes src/GeneratedConfig.php",
    "pestphp/pest-plugin": "post-autoload-dump; writes vendor/pest-plugins.json",
    "dealerdirect/phpcodesniffer-composer-installer": "post-install-cmd/post-update-cmd; writes CodeSniffer.conf through phpcs",
